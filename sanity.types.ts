...
export type AllSanitySchemaTypes = Address | User | SanityImageCrop | SanityImageHotspot | Blogcategory | Slug | Blog | BlockContent | Author | Order | Product | Brand | Category | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
...
// Query: *[_type == 'order' && clerkUserId == $userId] | order(orderData desc){  ...,product[]{    ...,product->  }}
