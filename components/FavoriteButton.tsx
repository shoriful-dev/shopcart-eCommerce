    ...
    <>
      {!showProduct ? (
        <Link href={'/wishlist'} className="group relative">
          <Heart className="w-5 h-5 hover:shadow-shop_light_green hoverEffect" />
        ...
        >
          {existingProduct ? (
            <Heart fill='#3b9c3c' className="text-shop_light_green/80 group-hover:text-shop_light_green hoverEffect mt-0.5 w-5 h-5" />
          ) : (
